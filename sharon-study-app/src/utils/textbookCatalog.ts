  ...
  },
  {
    ...
    books: [
      ...
      },
      {
        ...
        chapters: ['必背古诗文名篇与情境默写', '第一单元 先秦诸子散文', '第二单元 诗歌意象与意境', '第三单元 现当代小说与长篇名著', '第四单元 逻辑与思维']
      },
      {
        id: 'chi-sr2',
        grade: '高二',
        ...
        chapters: ['必背古诗文名篇与情境默写', '第一单元 史传文学与家国情怀', '第二单元 科学精神与理性思维', '第三单元 古代文论与文化经典', '第四单元 散文情思']
      },
      {
        id: 'chi-sr3',
        grade: '高三',
        ...
        chapters: ['必背古诗文名篇与情境默写', '第一单元 古代学术论著研读', '第二单元 外国经典小说', '第三单元 古代诗歌专题', '高考文言文与写作突破']
      }
    ]
  },
  {
